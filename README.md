...
Ideally, a 4-channel solid-state relay should be used for the 36-watt Philips BTA Fluorescent Ballast and 1 relay for the 18-watt Philips BPL. This doesn't need an additional relay since it uses a series ignitor.
